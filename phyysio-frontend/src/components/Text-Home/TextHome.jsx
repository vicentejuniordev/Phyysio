      ...
      <div className="text-home-container">
        <div className="text-home">
          ...
          <p className="text-simple">
            A rotina de uma clínica de fisioterapia exige organização, atenção
            aos pacientes e controle de informações. O Phyysio foi criado para
            substituir processos manuais e papéis por um sistema simples,
            confiável e fácil de usar.
          </p>
          <button className="primary-btn">Conhecer o sistema</button>
        </div>
